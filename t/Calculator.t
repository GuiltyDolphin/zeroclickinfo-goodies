...
ddg_goodie_test(
    ...
    '2pi'                   => build_test('≈ 6.28318530718', '2pi'),
    ...
    'tangent(pi/4)'        => build_test('1', 'tan(pi / 4)'),
    ...
    'sqrt(pi)'               => build_test('≈ 1.772453850906', 'sqrt(pi)'),
    'sqrt(3 pi / 4 + 1) + 1' => build_test('≈ 2.831991945996', 'sqrt(3pi / 4 + 1) + 1'),
    ...
    'pi/1e9'                          => build_test('≈ 3.14159265359 * 10 ^ -9', 'pi / 1 * 10 ^ 9'),
    'pi*1e9'                          => build_test('≈ 3,141,592,653.59', 'pi * 1 * 10 ^ 9'),
    '3pi + 7'                         => build_test('≈ 16.42477796077', '3pi + 7'),
    'pi - pi'                         => build_test('0', 'pi - pi'),
    # Nationalization
